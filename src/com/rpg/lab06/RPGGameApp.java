...
public class RPGGameApp {
    public static void main(String[] args) {
        System.out.println("\n" + "=".repeat(70));
        System.out.println(" LAB 06: DECORATOR PATTERN - RPG GAME ENHANCEMENT");
        ...
        System.out.println("\n" + "=".repeat(70));
        System.out.println(" [STEP 6] DECORATOR PATTERN: Runtime Composition");
        System.out.println("=".repeat(70));
        System.out.println("\n✨ KEY CONCEPT: Character attacks are decorated with effects!");
        System.out.println(" Style decorators (Warrior/Mage/Archer) are automatically applied.");
        System.out.println(" Generic decorators (CriticalStrike/DamageBoost/LifeSteal) can be stacked!\n");

        System.out.println("--- Aragorn and Mage attacks each other (Character - Destructible) ---");
        System.out.println("\n** Decorator Chain Applied: WarriorStyle -> CriticalStrike -> DamageBoost -> LifeSteal\n");
        
        // Apply additional decorators to warrior's attack at runtime
        warrior.setAttack(
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.println();
            if (!mage.isAlive()) {
                System.out.println("Mage has been defeated!");
                break;
            }
            mage.attack(warrior);
            System.out.println();
