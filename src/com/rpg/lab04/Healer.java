...
public class Healer extends Character {
    ...
    public void healAlly(Character ally) {
        ...
        // เพิ่ม HP จริง
        ally.setCurrentHealth(ally.getCurrentHealth() + healAmount);

        System.out.println("Restored " + healAmount + " HP to " + ally.getName() +
                "! Their HP: " + ally.getCurrentHealth() + "/" + ally.getMaxHealth());
    }
